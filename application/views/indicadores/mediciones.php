...
<div class="container">
<form method="POST" action="<?= base_url('index.php/Indicadores/ResultMediciones'); ?>">
  <div class="row col-xs-6">
      ...
      <button type="button" id="btnFiltrar3" class="btn btn-info">Filtrar resultados <i class="fa fa-filter" aria-hidden="true"></i></button>
...
<div class="row">
	...
	<div class="col-md-11 col-md-offset-1" style="overflow: scroll; height: 500px;">
		<table class="table tablaListaIndS table-hover" border=1 id="tablaMedicion">
		<thead>
		 <tr>
			...
			echo "<tr>";
		 	...
		 	foreach ($indicadoresUnidad as $row) {
				echo "<tr>";
					...
					echo 	'</div></td><td width=30 style="display:none" >'.$row['evaluacion'].'</td>';
				echo "<tr>";
			};
		}
	}
