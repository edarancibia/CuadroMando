		...
		<div class="col-md-9 col-md-offset-1">
			<table class="table">
					...
					<div class="dropdown">
                        ...
                        <ul class="dropdown-menu" role="menu" aria-labelledby="dropdownMenu">
                        	<li class="dropdown">
                            	...
                            	<a href='<?php echo base_url('index.php/Indicadores/MisIndicadores3?idUnidad=1&subdivision=Cirugia infantil') ?>'>Cirugía infantil</a>
				...
				<tr>
					...
					<td><a href="<?php echo base_url('index.php/Indicadores/MisIndicadores?idUnidad=6')?>" class="btn btn-primary">Anatomia Pat.</a></td>
					<td><a href="<?php echo base_url('index.php/Indicadores/MisIndicadores?idUnidad=7')?>" class="btn btn-primary">Diag. Ambulatorio</a></td>
					<td><a href="<?php echo base_url('index.php/Indicadores/MisIndicadores?idUnidad=8')?>" class="btn btn-primary">Farmacia</a></td>
				</tr>
				<tr>
					<td><a href="<?php echo base_url('index.php/Indicadores/MisIndicadores?idUnidad=9')?>" class="btn btn-primary">Esterilización</a></td>
					<td><a href="<?php echo base_url('index.php/Indicadores/MisIndicadores?idUnidad=10')?>" class="btn btn-primary">Imagenología</a></td>
					<td><a href="<?php echo base_url('index.php/Indicadores/MisIndicadores?idUnidad=11')?>" class="btn btn-primary">Kinesiterapia</a></td>
					<td><a href="<?php echo base_url('index.php/Indicadores/MisIndicadores?idUnidad=12')?>" class="btn btn-primary">Laboratorio</a></td>
				</tr>
				<tr>
					<td><a href="<?php echo base_url('index.php/Indicadores/MisIndicadores?idUnidad=13')?>" class="btn btn-primary">Oncología</a></td>
					<td><a href="<?php echo base_url('index.php/Indicadores/MisIndicadores?idUnidad=14')?>" class="btn btn-primary">Post operado</a></td>
					<td><a href="<?php echo base_url('index.php/Indicadores/MisIndicadores?idUnidad=15')?>" class="btn btn-primary">Res. Médica</a></td>
					<td><a href="<?php echo base_url('index.php/Indicadores/MisIndicadores?idUnidad=16')?>" class="btn btn-primary">Vacunatorio</a></td>
				</tr>
			</table>
		</div>
	</div>
